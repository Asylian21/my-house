...
Spoločný murovaný pilierik zostáva. Predstena sa ukončí podľa princípu Knauf W623.de-B2. Dosky sa nesmú natvrdo oprieť ani o pilierik, ani o krátke dorovnanie ostenia pod ich lícom. Netreba rozdeliť pilierik, pridávať oceľový rám ani vyrábať ďalšiu zalomenú akustickú predstenu.
...
Pri masívnom ostení použiť systémový UD 28/27 s podtesnením Trennwandkitt a kotvami vhodnými do podkladu. Ide o bežné mechanické pripojenie podľa W623-B2. Tesnenie pod profilom uzatvára obvodový styk; nenahrádza pružné závesy v ploche H200. Vatu dotiahnuť k ukončeniu bez maltového alebo penového klinu naprieč dutinou.[^1][^3]
...
Skontrolovať podtesnenie profilu, vatu, obe línie J1/J2 a neporušenie oddelenia obložkou. Vyhotoviť fotografiu pred uzavretím. Pri podlahe a strope uzavrieť aj konce škáry; nenechať otvorenú cestu cez dutinu. Finálnu šírku obložiek zosúladiť s omietkou a obkladom pred objednaním dverí.
...
Toto je jednoduchý projektový detail napojenia. Spoločný pilierik zostáva možnou bočnou cestou zvuku a systémové obvodové kotvy sa zachovávajú. Detail znižuje riziko netesností a neúmyselných pevných mostov; neurčuje výsledné Rw ani nepotvrdzuje 51 dB hotových miestností. Výpočtový odhad H200 sa tým nemení na meranie. Presné kotvy, podklad a kompatibilitu napojenia potvrdí dodávateľ pri príprave montáže.

## Technické zdroje

[^1]: [Knauf W61_DSS.de · vydanie 09/2026](https://media.knauf.com/a/EDKwYfTuyWRUkKKKihg9E7). S. 19, W623.de-B2 Anschluss Massivwand; s. 31, obvodové tesnenie a montáž. Živý odkaz už poskytuje novšie vydanie než W61.de 11/2023 použité v pôvodnej rešerši. Overenie tohto styku neznamená automatickú zámenu dosiek H200 za nový výrobok Silentboard 2in1.

[^2]: [Knauf Trenn-Fix · montážne pokyny](https://knauf.com/de-DE/p/produkt/trenn-fix-10665_0010). Odstup dosky 5 mm, vyplnenie škáry tmelom proti oddeľovaciemu pásiku a zachovanie oddelenia pri maľovaní.

[^3]: [Knauf Trennwandkitt · tesnenie styku profilov](https://knauf.com/cs-CZ/p/vyrobek/trennwandkitt-10667_0106). Výrobok na utesnenie obvodových pripojení pri akustických požiadavkách. Výrobca uvádza dve húsenice s priemerom 8 mm; nanášanie prispôsobiť predpísanému profilu a podkladu.

[^4]: [SAPELI · montáž otočných polodrážkových dverí](https://www.sapeli.cz/sites/default/files/otocne-polodrazkove-bytove-provedeni-dvoudilny-zaves.pdf). Príklad výrobcom určenej akustickej PUR peny. Nie je výberom značky ani konkrétnej zárubne pre tento dom.

[^5]: [Knauf · Perimeter Acoustical Sealing](https://knauf.com/api/download-center/v1/assets/bd031dd0-99ae-433b-ae77-5fb12675cef9?country=my&download=true). Príručka systému priečok, s. 21: pružnosť, nízka tvrdosť a trvalá priľnavosť tesniaceho tmelu. Všeobecná opora princípu mäkkého tesnenia; nie skúška tohto J2 ani predpis konkrétnej značky tmelu.
