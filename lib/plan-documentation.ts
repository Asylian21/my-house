...
export const PLAN_ROOM_NOTES:Record<string,string[]>={
  ...
  'ROOM-1-08':['Jedno klasické dvojkrídlové okno 1 600 × 1 350 mm pri pracovnom stole, parapet 900 mm. Veľké stredové presklenie aj okno pri posteli sú odstránené.','Plocha jediného stavebného otvoru je 2,16 m². Ide o plochu otvorov, nie výpočet denného osvetlenia. Vonkajšie tienenie, bezpečnostné sklo a preklady dopracuje projektant.','Izba je medzi dvoma nosnými stenami 300 mm: západná (líce 15 243 mm) je o 100 mm bližšie než predtým v prospech spálne a kúpeľne, východná k zádveriu je v jednej línii so stenou chlapčenskej izby. Izba má 5 298 × 2 908 mm (15,41 m²), presne ako chlapčenská: chodba je vystredená a stena k nej leží na 6 412 mm. Okno pri stole končí 200 mm pred východnou nosnou stenou.','Dvere 900 mm sú vystredené na dĺžku izby (17 442–18 342 mm) a ležia presne oproti dverám chlapčenskej izby. Zariadenie je zrkadlovým obrazom chlapčenskej izby: skriňa 1 600 × 600 mm stojí pri stene chodby v rohu pri zádverí, 599 mm od zárubne; regál na hračky je zrušený.'],
  'ROOM-1-09':['Úzky pevný sklenený pás 800 × 2 400 mm bez otvárania. Za 200 mm pilierom je štvorcové otváravé okno 1 200 × 1 200 mm s parapetom 1 200 mm. Celé okno je vľavo od stola a pánt je na strane pevného pásu, takže otvorené krídlo nezasahuje do pracovnej plochy. Nástenka je na bočnej stene.','Izba má 5 298 × 2 908 mm (15,41 m²), presne ako dievčenská: západná nosná stena je o 100 mm bližšie v prospech spálne a kúpeľne a stena k chodbe leží na 7 791 mm, v jednej rovine so stenou spálne a šatníka. Presklenie do dvora sa posunulo o 100 mm s posteľou, pred ktorou zostáva 217 mm k sklu.','Dvere 900 mm sú vystredené (17 442–18 342 mm) presne oproti dverám dievčenskej izby. Skriňa 1 600 × 600 mm stojí pri stene chodby v rohu pri zádverí, 599 mm od zárubne; regál na hračky je zrušený.'],
...
export const PLAN_ITEMS_ALL:PlanItem[]=[...grouped.values()].map(item=>{
  ...
  if(opening?.id==='GARDEN-BOY-DESK')Object.assign(item,{name:'Štvorcové otváravé okno vedľa stola',roomId:'ROOM-1-09',note:'Otváravé okno 1 200 × 1 200 mm, parapet 1 200 mm, 200 mm od pevného pásu. Horná hrana 2 400 mm je zarovnaná s pásom a portálmi. Antracitové obvodové aj krídlové profily 45 mm. Pravé ostenie končí 41 mm pred stolom; ľavý pánt pri páse vedie krídlo do voľného priestoru.'});
  ...
  if(garden?.id==='GARDEN-03')Object.assign(item,{name:'Pevný sklenený pás',roomId:'ROOM-1-09',note:'Zvislá neotváravá tabuľa 800 × 2 400 mm v antracitovom ráme 45 mm, bez stredového stĺpika, krídiel a kľučiek. Horná hrana je zarovnaná s vedľajším oknom.'});
