...
export const WALK_AVATARS = [
  {
    ...
    icon: "person",
    modelUrl: "/assets/avatar/avatar.glb",
    diffuseUrl: "/assets/avatar/michelle-light-diffuse.png",
    modelScale: 1,
    headingOffsetRad: 0,
  ...
  },
  {
    ...
    icon: "shield",
    modelUrl: "/assets/avatar/vanguard.glb",
    modelScale: 1,
  ...
  },
  {
    ...
    icon: "robot",
    modelUrl: "/assets/avatar/robot-expressive.glb",
    modelScale: 0.37,
    headingOffsetRad: 0,
