...
export const SOURCES = {
  ...
  clientRevision20260821: {
    ...
    detail:
      "Ponechať komín v hlavnom obytnom/kuchynskom priestore a odstrániť druhý komín pri zóne 1.09; FV pole na dvorovej rovine nad kuchyňou posunúť bližšie k bočnej terase a mimo ponechaného komína; garážovú bránu presunúť na uličnú fasádu namiesto prvého garážového okna a viesť príjazd priamo od ulice.",
    date: "21. 8. 2026",
...
export const HOUSE = Object.freeze({
  ...
  photovoltaics: {
    ...
    rows: 2,
    columns: 3,
    firstModuleCenterMm: { x: 21820, y: 12600 } satisfies Point2Mm,
