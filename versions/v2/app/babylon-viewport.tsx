...
import type {
  CameraPreset,
  TwinSceneController,
} from "@/versions/v2/lib/babylon-scene";
import {
  doorInteractionPromptLabel,
  type DoorInteractionSnapshot,
} from "@/versions/v2/lib/babylon-doors";
import type { FoundationStrip, LayerId, ViewMode } from "@/versions/v2/lib/twin-site";
import type {
  FlightCommand,
  NavigationMode,
  RenderQualityProfile,
} from "@/versions/v2/lib/twin-viewport-contract";
import { CAMERA_PRESETS, type CameraPresetId } from "@/versions/v2/lib/twin-commands";
import {
...
} from "@/versions/v2/lib/twin-garage";
import {
  ...
  walkAvatarOption,
  type WalkAvatarId,
} from "@/versions/v2/lib/twin-avatar";
...
>(function BabylonViewport(
  ...
  useEffect(() => {
    ...
    void import("@/versions/v2/lib/babylon-scene")
            ...
            <div className="hud-slot hud-end">
              <div className="hud-controls hud-fade">
                ...
                <a
                  ...
                  href="/v2-assets/archviz/garden-4k.jpg"
                  target="_blank"
