...
export class TwinSceneController {
  ...
  constructor(
    ...
    const environment = new HDRCubeTexture(
      "/v2-assets/assets/archviz/sky.hdr",
      this.scene,
      256,
      false,
      true,
    ...
    this.poolWaterNormal = new Texture(
      "/v2-assets/assets/textures/pool-water-normal.png",
      this.scene,
      false,
      false,
    ...
    for (const [index, material] of [
      ...
      const foliage = new Texture(
        "/v2-assets/assets/textures/hedge-privet-albedo.png",
        this.scene,
        false,
        false,
        Texture.TRILINEAR_SAMPLINGMODE,
    ...
    this.configurePlantCardMaterial(
      ...
      "/v2-assets/assets/vegetation/ornamental-grass-card.png",
    );
    this.configurePlantCardMaterial(
      this.realisticMaterials.plantPerennial,
      "/v2-assets/assets/vegetation/perennial-cluster-card.png",
    );
  ...
  private applyTexture(
    ...
    const albedo = new Texture(
      `/v2-assets/assets/textures/${albedoName}.jpg`,
      this.scene,
      false,
      false,
      Texture.TRILINEAR_SAMPLINGMODE,
    ...
    if (normalName) {
      const bump = new Texture(
        `/v2-assets/assets/textures/${normalName}.jpg`,
        this.scene,
        false,
        false,
        Texture.TRILINEAR_SAMPLINGMODE,
