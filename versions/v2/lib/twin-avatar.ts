...
export const WALK_AVATARS = [
  {
    ...
    icon: "person",
    modelUrl: "/v2-assets/assets/avatar/avatar.glb",
    diffuseUrl: "/v2-assets/assets/avatar/michelle-light-diffuse.png",
    modelScale: 1,
    headingOffsetRad: 0,
  ...
  },
  {
    ...
    icon: "shield",
    modelUrl: "/v2-assets/assets/avatar/vanguard.glb",
    modelScale: 1,
  ...
  },
  {
    ...
    icon: "robot",
    modelUrl: "/v2-assets/assets/avatar/robot-expressive.glb",
    modelScale: 0.37,
    headingOffsetRad: 0,
