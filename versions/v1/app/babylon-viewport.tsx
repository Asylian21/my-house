...
import type {
  CameraPreset,
  TwinSceneController,
} from "@/versions/v1/lib/babylon-scene";
import {
  doorInteractionPromptLabel,
  type DoorInteractionSnapshot,
} from "@/versions/v1/lib/babylon-doors";
import type { FoundationStrip, LayerId, ViewMode } from "@/versions/v1/lib/twin-site";
import type {
  FlightCommand,
  NavigationMode,
  RenderQualityProfile,
} from "@/versions/v1/lib/twin-viewport-contract";
import { CAMERA_PRESETS, type CameraPresetId } from "@/versions/v1/lib/twin-commands";
import {
  WORKSPACE_MODE_OPTIONS,
  type ChromeContract,
  type WorkspaceMode,
} from "@/versions/v1/lib/twin-ui-mode";
import {
  GARAGE_VEHICLE,
...
} from "@/versions/v1/lib/twin-garage";
import {
  ...
  walkAvatarOption,
  type WalkAvatarId,
} from "@/versions/v1/lib/twin-avatar";
...
>(function BabylonViewport(
  ...
  useEffect(() => {
    ...
    void import("@/versions/v1/lib/babylon-scene")
