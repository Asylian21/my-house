...
- **Prelet** in the visible dock, **Prelet okolo domu** in the pause menu, or **H** enters free exterior flight. WASD/arrows move horizontally, E/Q raise/lower the camera, Shift boosts and Alt slows flight; the wheel moves along the view direction. H or **Prechádzka** returns to the validated living-room walking entry. Tab exposes on-screen movement and altitude controls; Escape pauses/resumes. See [current UI and verification](../../docs/unreal-game-ui.md).
