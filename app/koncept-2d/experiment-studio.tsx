...
<svg ref={svg} className="fp-plan" viewBox={full?'5500 -23100 23700 21500':'5550 -12350 17300 10850'} role="img" aria-label="Koncept E so spálňou do dvora, súkromným šatníkom a zalomeným vstupom">
          ...
          </svg></div></div><div className="fp-sheet-footer"><div className="fp-legend"><span><i className="parent"/>Súkromná spálňa</span><span><i className="private-closet"/>Súkromný šatník</span><span><i className="children"/>Detské izby</span><span><i className="walls"/>Steny a priečky</span><span><i className="insulation"/>Zateplenie 20 cm na murive 30 cm</span></div><span>Oranžová trasa: spoločný prechod mimo spálne</span></div></div>
