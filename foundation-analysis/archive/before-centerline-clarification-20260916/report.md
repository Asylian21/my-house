...
Revízia 16. 9.: dohodnuté sú štyri rebrá R1, R2, R4 a R7, zakreslené na strane 2. Modrá je už vyliaty obvod, červená nové rebrá. Výpočty a množstvá ďalej patria pôvodnej štúdii so 17 trasami. Pre štyri rebrá neboli prepočítané. MEDIUM s doskou180 mm je kandidát pôvodnej výpočtovej rodiny; nejde o potvrdenie novej štvorrebrovej zostavy.
...
| Rebro / od kraja* | Šírka** | Do bližšieho líca | Do osi | Do ďalšieho líca |
| --- | --- | --- | --- | --- |
| R7 / ľavý A | 350 mm | 8299 mm | 8474 mm | 8649 mm |
| R1 / pravý C | 350 mm | 6999,5 mm | 7174,5 mm | 7349,5 mm |
| R2 / uličný B | 350 mm | 7508 mm | 7683 mm | 7858 mm |
| R4 / zadný D | 350 mm | 2500 mm | 2675 mm | 2850 mm |
*Referencie: vonkajšie líca NAVRHOVANÉHO horného obvodu širokého350 mm; A=X6619, B=Y3179, C=X27866, D=Y21860. Nie sú to zamerané kraje vyliateho betónu. **350 mm je pracovná šírka zo štúdie so17trasami; pre zostavu4rebier staticky nepotvrdená. Ide o šírku rebra, nie výkopu či spodnej pätky. Líc rebra = os ±175 mm.
Technický výkres ZK-01/ZK-02: drawings/technical/agreed-ribs-technical.pdf, A3, pôdorys1:100 pri tlači100 %. Obsahuje kótové reťazce, obe hrany rebier, detail šírky a podmienené prepočty od380/400mm spodného pásu. Údaje o skutočných hranách a súososti chýbajú. Modrý L-obvod zahŕňa lodžiu aj terasu; R1 a R2 spája krátky úsek obvodu.
Zdroj: označený obrázok investora zo16.9.2026 a modelové osi. R3, R5, R6 a R8-R17 nie sú v aktuálnej dohode. Strany3-10 zachovávajú označenú pôvodnú štúdiu; jej výsledky sa na štyri rebrá neprenášajú.
